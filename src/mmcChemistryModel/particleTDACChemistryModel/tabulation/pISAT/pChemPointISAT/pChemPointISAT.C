...
Foam::scalar Foam::pChemPointISAT<ReactionThermo, ThermoType>::tolerance_;

//for testing 
template<class ReactionThermo, class ThermoType>
Foam::label Foam::pChemPointISAT<ReactionThermo, ThermoType>::leafCount_;

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::qrDecompose
(
    const label nCols,
...
template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::qrUpdate
(
    scalarSquareMatrix& R,
    const label n,
...
template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::rotate
(
    scalarSquareMatrix& R,
    const label i,
    const scalar a,
...
template<class ReactionThermo, class ThermoType>
Foam::pChemPointISAT<ReactionThermo, ThermoType>::pChemPointISAT
(
    ...
    pBinaryNode<ReactionThermo, ThermoType>* node
)
:
    ...
    leafID_(leafCount_++) //for testing 
{
    ...
    for (label i=0; i<reduOrCompDim; i++)
    {
        for (label j=0; j<reduOrCompDim; j++)
        {
            ...
            label safeFactor = 1; //factor of how conservative the ellipsoid is 
            // SF*A/tolerance
            ...
            Atilde(i, j) /= (tolerance/safeFactor*scaleFactor[compi]);
        }
    }
...
//    {
//    Pout<< leafID_ << "th leaf is added."<< endl;
//    }
...
Foam::pChemPointISAT<ReactionThermo, ThermoType>::pChemPointISAT
(
    Foam::pChemPointISAT<ReactionThermo, ThermoType>& p
)
:
...
template<class ReactionThermo, class ThermoType>
bool Foam::pChemPointISAT<ReactionThermo, ThermoType>::inEOA(const scalarField& phiq)
{
...
template<class ReactionThermo, class ThermoType>
bool Foam::pChemPointISAT<ReactionThermo, ThermoType>::checkSolution
(
...
template<class ReactionThermo, class ThermoType>
bool Foam::pChemPointISAT<ReactionThermo, ThermoType>::grow(const scalarField& phiq)
{
    scalarField dphi(phiq - phi());
...
template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::increaseNumRetrieve()
{
    this->numRetrieve_++;
}
...
template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::resetNumRetrieve()
{
    this->numRetrieve_ = 0;
}
...
template<class ReactionThermo, class ThermoType>
void Foam::pChemPointISAT<ReactionThermo, ThermoType>::increaseNLifeTime()
{
    this->nLifeTime_++;
}
...
template<class ReactionThermo, class ThermoType>
Foam::label Foam::pChemPointISAT<ReactionThermo, ThermoType>::
