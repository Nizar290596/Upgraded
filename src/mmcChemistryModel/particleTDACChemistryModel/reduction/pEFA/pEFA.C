...
Foam::particleChemistryReductionMethods::pEFA<ReactionThermo, ThermoType>::pEFA
(
...
template<class ReactionThermo, class ThermoType>
void Foam::particleChemistryReductionMethods::pEFA<ReactionThermo, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
