...
Foam::particleChemistryReductionMethod<CompType, ThermoType>::
particleChemistryReductionMethod
(
    const Foam::IOdictionary& dict,
    Foam::particleTDACChemistryModel<CompType, ThermoType>& chemistry
)
:
    dict_(dict),
