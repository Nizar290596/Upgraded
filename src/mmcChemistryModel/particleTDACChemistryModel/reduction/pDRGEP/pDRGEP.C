...
Foam::particleChemistryReductionMethods::pDRGEP<ReactionThermo, ThermoType>::pDRGEP
(
...
template<class ReactionThermo, class ThermoType>
void Foam::particleChemistryReductionMethods::pDRGEP<ReactionThermo, ThermoType>::
reduceMechanism
(
    const scalarField &c,
    const scalar T,
