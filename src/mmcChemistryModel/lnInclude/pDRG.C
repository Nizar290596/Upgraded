...
Foam::particleChemistryReductionMethods::pDRG<ReactionThermo, ThermoType>::pDRG
(
...
template<class ReactionThermo, class ThermoType>
void Foam::particleChemistryReductionMethods::pDRG<ReactionThermo, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
