...
#include "pBinaryNode.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CompType, class ThermoType>
Foam::pBinaryNode<CompType, ThermoType>::pBinaryNode()
:
    leafLeft_(nullptr),
    leafRight_(nullptr),
    nodeLeft_(nullptr),
...
Foam::pBinaryNode<CompType, ThermoType>::pBinaryNode
(
    pChemPointISAT<CompType, ThermoType>* elementLeft,
    pChemPointISAT<CompType, ThermoType>* elementRight,
    pBinaryNode<CompType, ThermoType>* parent
)
:
...
template<class CompType, class ThermoType>
void Foam::pBinaryNode<CompType, ThermoType>::calcV
(
    pChemPointISAT<CompType, ThermoType>*& elementLeft,
    pChemPointISAT<CompType, ThermoType>*& elementRight,
    scalarField& v
...
template<class CompType, class ThermoType>
Foam::scalar Foam::pBinaryNode<CompType, ThermoType>::calcA
(
    pChemPointISAT<CompType, ThermoType>* elementLeft,
    pChemPointISAT<CompType, ThermoType>* elementRight
)
