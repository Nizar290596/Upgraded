...
#include "pBinaryTree.H"
#include "SortableList.H"

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::insertNode
(
    chP*& phi0,
    bn*& newNode
)
...
template<class ReactionThermo, class ThermoType>
bool Foam::pBinaryTree<ReactionThermo, ThermoType>::inSubTree
(
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::deleteSubTree(bn* subTreeRoot)
{
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::transplant(bn* u, bn* v)
{
    if (v != nullptr)
    {
        // u is root_
...
template<class ReactionThermo, class ThermoType>
Foam::pChemPointISAT<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::chemPSibling(bn* y)
{
    if (y->parent() != nullptr)
    {
    ...
    // the pBinaryNode is root_ and has no sibling
    return nullptr;
}
...
template<class ReactionThermo, class ThermoType>
Foam::pChemPointISAT<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::chemPSibling(chP* x)
{
    if (size_>1)
    {
...
template<class ReactionThermo, class ThermoType>
Foam::pBinaryNode<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::nodeSibling(bn* y)
{
    if (y->parent()!=nullptr)
    {
...
template<class ReactionThermo, class ThermoType>
Foam::pBinaryNode<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::nodeSibling(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::deleteAllNode(bn* subTreeRoot)
{
    if (subTreeRoot != nullptr)
    {
...
template<class ReactionThermo, class ThermoType>
Foam::pBinaryTree<ReactionThermo, ThermoType>::pBinaryTree
(
...
template<class ReactionThermo, class ThermoType>
Foam::label Foam::pBinaryTree<ReactionThermo, ThermoType>::depth(bn* subTreeRoot)
{
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::insertNewLeaf
(
    const scalarField& phiq,
...
)
{
    ...
    else // at least one point stored
    {
        ...
        // the hyper plane is computed in the pBinaryNode constructor
        bn* newNode;
        if (size_>1)
        {
        ...
        {
            // when size is 1, the pBinaryNode is without hyperplane
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::binaryTreeSearch
(
    const scalarField& phiq,
    bn* node,
    chP*& nearest
...
template<class ReactionThermo, class ThermoType>
bool Foam::pBinaryTree<ReactionThermo, ThermoType>::secondaryBTSearch
(
    const scalarField& phiq,
    chP*& x
)
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::deleteLeaf(chP*& phi0)
{
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::balance()
{
...
template<class ReactionThermo, class ThermoType>
Foam::pChemPointISAT<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::treeMin(bn* subTreeRoot)
{
    if (subTreeRoot!=nullptr)
    {
...
template<class ReactionThermo, class ThermoType>
Foam::pChemPointISAT<ReactionThermo, ThermoType>*
Foam::pBinaryTree<ReactionThermo, ThermoType>::treeSuccessor(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::clear()
{
...
template<class ReactionThermo, class ThermoType>
bool Foam::pBinaryTree<ReactionThermo, ThermoType>::isFull()
{
...
template<class ReactionThermo, class ThermoType>
void Foam::pBinaryTree<ReactionThermo, ThermoType>::resetNumRetrieve()
{
