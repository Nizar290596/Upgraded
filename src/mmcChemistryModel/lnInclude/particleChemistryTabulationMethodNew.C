...
Foam::autoPtr<Foam::particleChemistryTabulationMethod<ReactionThermo, ThermoType>>
Foam::particleChemistryTabulationMethod<ReactionThermo, ThermoType>::New
(
...
)
{
    ...
    word chemistryTabulationMethodName =
      ...
      + word(dict.subDict("chemistryType").lookup("chemistryThermo")) + "ReactionThermo" + ','
      + thermoTypeName + '>';
    ...
    return autoPtr<particleChemistryTabulationMethod<ReactionThermo, ThermoType>>
    (
