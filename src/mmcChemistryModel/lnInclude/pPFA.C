...
Foam::particleChemistryReductionMethods::pPFA<ReactionThermo, ThermoType>::pPFA
(
...
template<class ReactionThermo, class ThermoType>
void Foam::particleChemistryReductionMethods::pPFA<ReactionThermo, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
