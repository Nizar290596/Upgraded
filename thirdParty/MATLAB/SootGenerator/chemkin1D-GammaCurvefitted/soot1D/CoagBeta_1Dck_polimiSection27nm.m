...
kf = 1.41*(1+2/1.8)^(1.8/2);
Rprimary = (27.3e-9)/2;%3.42e-9;%[m]
nCprimary = 962448;%40000;

if numC1 >=992448%80000
    parR1 = (5/3)^(1/2)*Rprimary*(numC1/nCprimary/kf)^(1/1.8);
else
    parR1 = ((3*parM1*Vfactor)/(4*parDensity1*pi))^(1/3); %[m]
end

if numC2 >=992448
    parR2 = (5/3)^(1/2)*Rprimary*(numC2/nCprimary/kf)^(1/1.8);
else
