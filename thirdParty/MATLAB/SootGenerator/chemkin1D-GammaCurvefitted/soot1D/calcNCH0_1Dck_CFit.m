...
nHp = 0;%1 + nC(11)-1;% nC(8)-1+2-1
    ...
    if nCp > nC(1)
        ...
        LumpC = [pC1,pC2];
        AB = [pC1coeff,pC2coeff];
        buildReaction0_1Dck;%build reaction        
    end
    ...
    if SecCoeffs(ri,1) == -1 %for coagulation
        ...
        coeffA = 1e3*CoagBeta_1Dck(reactantCn1,reactantCn2,reactantHn1,reactantHn2);
        
        %Gamma = CoagGamma_1Dck(reactantCn1,reactantCn2,reactantHn1,reactantHn2)
        GammaArrConst{ri}(1:4) = CoagGamma_1Dck_CFit(reactantCn1,reactantCn2,reactantHn1,reactantHn2);
        
        GammaArrConst{ri}(5) = CoagGamma_1Dck(reactantCn1,reactantCn2,reactantHn1,reactantHn2);
        ...
        %E(cal/mol)
        FoamArrCoeffs{ri}(3) = SecCoeffs(ri,3);
