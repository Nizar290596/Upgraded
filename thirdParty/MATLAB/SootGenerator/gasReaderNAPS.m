...
elementsList = {'O','H','C','N','Ca','S','Si','AR'};

%read data of reactions
%fileDict = '/Users/zhijiehuo/Dropbox/DelftFlameResults/FOAMformat/gasChem.txt';
fileDict = '/Users/zhijiehuo/Dropbox/DelftFlameResults/FOAMformat/NAPSchemkin20sections/sootChemNAPS.inp';
...
SpeciesNames = SpeciesNames(~cellfun('isempty',SpeciesNames));
if strcmp(SpeciesNames(end),'END')
    SpeciesNames(end)=[];
end
